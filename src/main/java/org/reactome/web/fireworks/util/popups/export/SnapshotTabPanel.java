...
public class SnapshotTabPanel extends FlowPanel {
    ...
    public SnapshotTabPanel(final Image snapshot) {
        ...
        if (isIE) {
            ...
            button.setTitle("Save diagram as PNG image");

            Anchor anchor = new Anchor();
            anchor.setHref(snapshot.getUrl());
            anchor.getElement().setAttribute("download", "PathwaysOverview.png");
//            anchor.addClickHandler(clickEvent -> closeDialog());
        ...
        if(gsUploadByPostAvailable()){
            ...
            genomespace.addClickHandler(event -> {
                ...
                uploadToGenomeSpace(base64, mimeString, "png", "PathwaysOverview");
//                closeDialog();
            });
...
//    }
    ...
    public interface ResourceCSS extends CssResource {
         ...
         */
        String CSS = "org/reactome/web/fireworks/util/popups/export/SnapshotTabPanel.css";
