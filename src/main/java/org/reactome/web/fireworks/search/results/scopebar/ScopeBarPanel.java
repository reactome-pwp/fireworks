package org.reactome.web.fireworks.search.results.scopebar;
...
public class ScopeBarPanel extends FlowPanel implements ClickHandler {
     ...
     */
    @CssResource.ImportedWithPrefix("fireworks-ScopeBarPanel")
    public interface ResourceCSS extends CssResource {
        /**
         * The path to the default CSS styles used by this resource.
         */
        String CSS = "org/reactome/web/fireworks/search/results/scopebar/ScopeBarPanel.css";
